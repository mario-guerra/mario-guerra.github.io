...
const projects = [
  ...
  },
  {
    ...
    description: "A structured 5-part curriculum bridging academic computer science and agentic engineering. Guides students from foundational coding loops through API design, JWT security, Docker, CI/CD deployment, and integrating agentic capabilities into local applications.",
  ...
  },
  {
    ...
    tags: ["Microsoft Graph API", "Azure Foundry", "RAG", "Microsoft Teams", "Knowledge Mining"],
